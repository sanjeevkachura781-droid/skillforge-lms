...
export interface User { id: number; firstName: string; lastName: string; email: string; role: Role; status: string; }
...
export interface Course { id: number; instructorId: number; categoryId: number; title: string; slug: string; shortDescription: string; description: string; thumbnailUrl?: string | null; level: CourseLevel; status: string; category?: Category; instructor?: User; modules?: CourseModule[]; }
...
export interface QuizOption { id: number; optionText: string; position: number; }
export interface QuizQuestion { id: number; questionText: string; position: number; points: number; options: QuizOption[]; }
export interface Quiz { id: number; title: string; description?: string | null; passingPercentage: number; questions: QuizQuestion[]; courseId: number; }
